#undef SHOOTINGGAMESYSTEMCP_API
...
#define UE_PROJECT_NAME ShootingGameSystemCP
#define UE_TARGET_NAME ShootingGameSystemCPEditor
...
#define SHOOTINGGAMESYSTEMCP_API DLLEXPORT
